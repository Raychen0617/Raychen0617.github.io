        ...
        <div  className="opacity-100 bg-white flex flex-row font-poppins py-6">
            ...
            <div className="flex flex-row ml-auto mr-5">
                <span className="font-regular text-gray-500">
                    ...
                    <Link to="qualification" smooth={true} duration={1500} offset={-300} className="ml-5 hover:underline underline-offset-8 decoration-gray-500">Qualification</Link>
                    <Link to="skill" smooth={true} duration={1500} offset={-380} className="ml-5 hover:underline underline-offset-8 decoration-gray-500">Skill</Link>
                    <Link to="project"  smooth={true} duration={1500} offset={-250} className="ml-5 hover:underline underline-offset-8 decoration-gray-500">Project</Link>
                    <Link to="publication"  smooth={true} duration={1500} offset={-400} className="ml-5 hover:underline underline-offset-8 decoration-gray-500">Publication</Link>
