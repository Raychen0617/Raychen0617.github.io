...
const PublicationPage = () => {
    return (
        <div id="publication" className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-row items-center justify-center">
                    ...
                    <div className="ml-8 flex flex-col bg-white rounded-lg shadow-lg p-6 mr-4">
                        ...
                        <p className="text-gray-600 font-poppins mt-2">
                            <li className="mt-2">
                                {" "}
                                The research paper has been accepted for
                                publication at ICCV 2023
                            </li>
                            <li className="mt-2">
                                {" "}
                                Devise a dual‑branch vision transformer network
                                for group affect recognition with minimum data
                                preprocessing{" "}
                            </li>
                            <li className="mt-2">
                                {" "}
                                With parameters less than 10x, our proposed
            ...
            <div className="md:hidden">
                <div className="flex flex-col items-center justify-center">
                    <img
                        src={ICCV}
                        className="rounded-xl shadow-lg w-32 h-auto p-2"
                    />
                    <div className="mt-8 flex flex-col bg-white rounded-lg shadow-lg p-6 mx-4">
                        <h3 className="flex items-center mb-1 text-lg text-xl font-bold text-gray-900 dark:text-white font-poppins">
                            Most Important Person-Guided Dual-Branch Cross-Patch
                            Attention for Group Affect Recognition
                        </h3>
